...
class TutorsControllerTest < ActionController::TestCase
  ...
  test "should create tutor" do
    assert_difference('Tutor.count') do
      post :create, tutor: { email: @tutor.email, password: @tutor.password, pseudonym: @tutor.pseudonym }
    end
  ...
  test "should update tutor" do
    patch :update, id: @tutor, tutor: { email: @tutor.email, password: @tutor.password, pseudonym: @tutor.pseudonym }
    assert_redirected_to tutor_path(assigns(:tutor))
  end
