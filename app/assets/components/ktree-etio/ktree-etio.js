        Polymer({
            ...
            addNode: function(obj, coeff, layer, i) {
               ...
               if (obj.enfant == "") {
                    ...
                    group.on('mouseout', function () {
                        ...
                        that = document.querySelector('ktree-etio');
                        if (title != "") {
                            that = document.querySelector('ktree-etio');
            ...
            ready: function () {
                this.drawNodes();
                document.getElementById("menuktree").innerHTML = "<p class=\" summary\"><b style=\"color: white\">I</b>] Etiologie</p><p class=\" summary\"><b style=\"color: white\">II</b>] Génétique</p><p class=\" summary\"><b style=\"color: white\">III</b>] Environnement</p><p class=\" summary\"><b style=\"color: white\">IV</b>] Interactions génétique/environnement</p>";
            }
 });
