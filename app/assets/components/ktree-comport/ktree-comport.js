        Polymer({
            ...
            addNode: function(obj, coeff, layer, i) {
               ...
               if (obj.enfant == "") {
                    ...
                    group.on('mouseout', function () {
                        ...
                        that = document.querySelector('ktree-comport');
                        if (title != "") {
                            that = document.querySelector('ktree-comport');
            ...
            start: function () {
                this.drawNodes();
                document.getElementById("ktreebouton2").innerHTML = "<a><button id=\"boutonactive\" onClick=\"document.querySelector('ktree-selector').showKtree('ktree-fonc')\">Revenir en arrière</button></a>";
                document.getElementById("menuktree").innerHTML = "<p class=\" summary\"><b class=\"romanumb\">I</b>] Domaine des emotions et du comportement</p><p class=\" summary\"><b class=\"romanumb\">II</b>] Emotions</p><p class=\" summary\"><b class=\"romanumb\">III</b>] Prevention, accompagnement et traitement des comportements-problemes, dont les troubles du comportement alimentaire et l’hyperactivite</p><p class=\" summary\"><b class=\"romanumb\">IV</b>] Sexualité</p>";
            }
 });
