        Polymer({
            ...
            addNode: function(obj, coeff, layer, i) {
               ...
               if (obj.enfant == "") {
                    ...
                    group.on('mouseout', function () {
                        ...
                        that = document.querySelector('ktree-comorbpipgec');
                        if (title != "") {
                            that = document.querySelector('ktree-comorbpipgec');
            ...
            start: function () {
                ...
                document.getElementById("menuktree").innerHTML = "<p class=\" summary\"><b class=\"romanumb\">I</b>] Les programmes d’interventions personnalisés, globaux et coordonnés</p><p class=\" summary\"><b class=\"romanumb\">II</b>] Les interventions de nature éducative, comportementale et développementales</p><p class=\" summary\"><b class=\"romanumb\">III</b>] Les interventions non recommandées</p><p class=\" summary\"><b class=\"romanumb\">IV</b>] Les interventions non consensuelles</p>";
            }
 });
