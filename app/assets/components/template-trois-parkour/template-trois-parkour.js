  ...
  is: "template-trois-parkour",
    ...
    addNode: function(obj, coeff, layer, i) {
        ...
        var node = new Konva.Circle({
            ...
            id: obj.name,
            text: obj.name,
            strokeWidth: Math.min(coeff[0], coeff[1]) / 6,
        });
        layer.add(node);
        ...
        node.on('click', function () {
            ...
            document.getElementById("status").innerHTML = "<paper-button raised " +
                " onClick=\"document.querySelector('my-parkour-three').changeStatus('" + obj.name + "', \'Success\')\">Success</paper-button>" +
                "<paper-button raised onClick=\"document.querySelector('my-parkour-three').changeStatus('" + obj.name + "', \'Failure\')\">Failure</paper-button>" +
                "<paper-button raised onClick=\"document.querySelector('my-parkour-three').changeStatus('" + obj.name + "', \'ok\')\">Cancel</paper-button>"
                +
                "<paper-button raised onClick=\"document.querySelector('my-parkour-three').changeStatus('" + obj.name + "', \'Reset\')\">Reset</paper-button>";
            desc.open();
        });
