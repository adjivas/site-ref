class StructuresController < ApplicationController
  ...
  private
    ...
    def structure_params
      params.require(:structure).permit(:name, :juridical_id, :description, :address, :longitude, :latitude, :email, :phone, :link, :departement_id, :published, :message, :reply, :user_id, :admin_id, :approved)
    end
end
